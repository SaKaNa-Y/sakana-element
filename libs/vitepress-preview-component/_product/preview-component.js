...
const U = /* @__PURE__ */ T(Y, [['render', oe]]),
  se = {},
  ce = {
    viewBox: '0 0 544 560',
    fill: 'none',
...
const z = /* @__PURE__ */ T(se, [['render', re]]),
...
const _e = /* @__PURE__ */ T(ae, [['render', ve]]),
  me = /* @__PURE__ */ Z({
                ...
                l.value
                  ? (d(),
                    p(
                      ...
                      [H(_e), i('span', null, b(u.content), 1)],
                      6,
                    ))
                  : M('', !0),
              ]),
  ...
  He = /* @__PURE__ */ Z({
    ...
    setup(o) {
      const t = o,
        e = A(),
        { isCodeFold: c, setCodeFold: l } = R(),
        { copyContent: _, clickCopy: m } = E(),
        h = v(decodeURIComponent(t.code)),
                      ...
                      [
                        n(c)
                          ? (d(),
                            y(O, {
                              key: 1,
                              onClick: g[1] || (g[1] = (_P) => n(l)(!1)),
                            }))
                          : (d(),
                            y(U, {
                              key: 0,
                              onClick: g[0] || (g[0] = (_P) => n(l)(!0)),
                            })),
                        H(z, { onClick: L }),
                      ],
                      2,
  ...
  Me = /* @__PURE__ */ Z({
    ...
    setup(o) {
      const t = o,
        ...
        { isCodeFold: c, setCodeFold: l } = R(),
        { clickCopy: _ } = E(),
        m = v(decodeURIComponent(t.code)),
        h = v(decodeURIComponent(t.showCode)),
        C = v(null),
        u = () => {
          _(m.value), D.open();
        },
                      ...
                      [
                        n(c)
                          ? (d(),
                            y(O, {
                              key: 1,
                              onClick: r[1] || (r[1] = (_w) => n(l)(!1)),
                            }))
                          : (d(),
                            y(U, {
                              key: 0,
                              onClick: r[0] || (r[0] = (_w) => n(l)(!0)),
                            })),
                        H(z, { onClick: u }),
                      ],
                      2,
...
export { He as AntDesignContainer, Me as ElementPlusContainer, we as NaiveUIContainer };
