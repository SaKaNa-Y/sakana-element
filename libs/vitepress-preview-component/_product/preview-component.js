import { ref as m, createElementBlock as v, openBlock as a, createElementVNode as i, defineComponent as V, watch as x, createBlock as _, Transition as j, withCtx as T, createCommentVNode as H, normalizeStyle as q, normalizeClass as r, unref as s, createVNode as y, toDisplayString as b, createApp as G, computed as F, onMounted as S, resolveComponent as z, renderSlot as B } from "vue";
const O = () => ({
  copyContent: m(""),
  clickCopy: async (t) => {
...
}, k = "vitepress-demo-preview", $ = (o, e, t, c) => {
  let l = e === "" ? `${o}` : `${o}-${e}`;
...
function Z(o) {
  return !o || typeof o != "string" ? "" : o.replace(/<script[\s>][\s\S]*?<\/script>/gi, "").replace(/<\/?script[^>]*>/gi, "").replace(/\s+on\w+\s*=\s*(?:"[^"]*"|'[^']*'|[^\s>]+)/gi, "");
}
const I = (o, e) => {
...
const R = /* @__PURE__ */ I(J, [["render", Q]]), W = {}, X = {
  viewBox: "0 0 544 560",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
};
function Y(o, e) {
  return a(), v("svg", X, e[0] || (e[0] = [
    i("path", {
...
const E = /* @__PURE__ */ I(W, [["render", Y]]), ee = {}, te = {
  t: "1661231422733",
  class: "icon",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
const D = /* @__PURE__ */ I(ee, [["render", ne]]), oe = {}, se = {
  width: "20",
  height: "20",
  viewBox: "0 0 48 48",
  fill: "currentColor",
...
const ie = /* @__PURE__ */ I(oe, [["render", ce]]), le = /* @__PURE__ */ V({
  ...
  setup(o, { expose: e }) {
    ...
    return e({
      ...
      default: T(() => [
        l.value ? (a(), v("div", {
          key: 0,
          class: r([s(c).bem("message-notice", "container")]),
          style: q({ top: f.value + "px" })
        }, [
          y(ie),
          i("span", null, b(C.content), 1)
        ], 6)) : H("", !0)
      ]),
      _: 1
    }));
  ...
  open: () => {
    ...
    const c = N.length, l = c === 0 ? 10 : (c + 1) * 10 + c * 42;
    t.setTopHeight(l), t.setVisible(!0), N.push(t);
  }
}, re = ["innerHTML"], ae = ["innerHTML"], Ce = /* @__PURE__ */ V({
  __name: "AntDesign",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = A(), { isCodeFold: c, setCodeFold: l } = U(), { clickCopy: p } = O(), f = m(decodeURIComponent(e.code)), L = m(Z(decodeURIComponent(e.showCode))), d = m(null), C = () => {
      p(f.value), P.open();
    }, g = F(() => {
      var n;
      return d.value ? (n = d.value) == null ? void 0 : n.clientHeight : 0;
    }), h = (n) => {
      c.value ? d.value.style.height = "0px" : d.value.style.height = `${n}px`;
    };
    return S(() => {
      const n = g.value;
      h(n);
      ...
      const w = z("ClientOnly");
      return a(), v("div", {
        class: r([s(t).e("ant-design__container")])
      }, [
        i("section", {
          class: r([s(t).bem("preview")])
        }, [
          y(w, null, {
            default: T(() => [
              B(n.$slots, "default")
        ...
        i("section", {
          class: r([s(t).bem("description")])
        }, [
          e.title ? (a(), v("div", {
            key: 0,
            class: r([s(t).bem("description", "title")])
          }, b(n.title), 3)) : H("", !0),
          e.description ? (a(), v("div", {
            key: 1,
            class: r([s(t).bem("description", "content")]),
            innerHTML: s(Z)(n.description)
          }, null, 10, re)) : H("", !0),
          e.description || !e.title && !e.description ? (a(), v("div", {
            key: 2,
            class: r([s(t).bem("description", "split-line")])
          }, null, 2)) : H("", !0),
          i("div", {
            class: r([s(t).bem("description", "handle-btn")])
          }, [
            s(c) ? (a(), _(D, {
              key: 1,
              onClick: u[1] || (u[1] = (M) => s(l)(!1))
            })) : (a(), _(R, {
              key: 0,
              onClick: u[0] || (u[0] = (M) => s(l)(!0))
            })),
            y(E, { onClick: C })
          ], 2)
        ], 2),
        i("section", {
          class: r([s(t).bem("source")]),
  ...
  setup(o) {
    ...
    return S(() => {
      ...
      const w = z("ClientOnly");
      return a(), v("div", {
        class: r([s(t).e("element-plus__container")])
      }, [
        i("section", {
          class: r([s(t).bem("preview")])
        }, [
  ...
  setup(o) {
    ...
    return S(() => {
      ...
      const w = z("ClientOnly");
      return a(), v("div", {
        class: r([s(t).e("naive-ui__container")])
      }, [
        i("section", {
          class: r([s(t).bem("name_handle")])
        }, [
          e.title ? (a(), v("div", {
            key: 0,
            class: r([s(t).bem("component", "name")])
          }, b(n.title), 3)) : H("", !0),
          i("div", {
            class: r([s(t).bem("description", "btns")])
          }, [
            y(E, { onClick: C }),
            s(c) ? (a(), _(D, {
              key: 1,
        ...
        e.description ? (a(), v("section", {
          key: 0,
          class: r([s(t).bem("description")])
        }, [
          i("span", null, b(n.description), 1)
        ], 2)) : H("", !0),
        i("section", {
          class: r([s(t).bem("preview")])
        }, [
