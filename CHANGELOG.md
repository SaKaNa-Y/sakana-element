...
* fix(ci): add rolldown platform bindings to onlyBuiltDependencies ([042cc6d](https://github.com/yu859/sakana-element/commit/042cc6d))
* fix(ci): bump Node.js to v20.19.0 for rolldown compatibility ([991878e](https://github.com/yu859/sakana-element/commit/991878e))
...
* docs: enhance CLAUDE.md and fix rolldown build dependency config ([7b8e095](https://github.com/yu859/sakana-element/commit/7b8e095))
