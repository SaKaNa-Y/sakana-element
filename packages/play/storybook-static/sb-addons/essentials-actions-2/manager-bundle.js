try {
  (() => {
    ...
    var _Tn = __STORYBOOK_COMPONENTS__,
      {
        A: _n,
        ActionBar: we,
        AddonPanel: vn,
    ...
    var _Fa = __STORYBOOK_CORE_EVENTS__,
      {
    ...
    var $t = 'actions',
      ...
      tr = fe({
        'node_modules/is-object/index.js'(_e, t) {
          t.exports = (r) => typeof r === 'object' && r !== null;
        },
      }),
      rr = fe({
        'node_modules/is-window/index.js'(_e, t) {
          t.exports = (r) => {
            if (r == null) return !1;
            var n = Object(r);
            return n === n.window;
      ...
      nr = fe({
        'node_modules/is-dom/index.js'(_e, t) {
          var r = tr(),
            n = rr();
          function a(i) {
