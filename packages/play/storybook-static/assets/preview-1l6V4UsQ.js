...
var T = (e, t) => typeof t[e] > 'u' && !(e in t),
  B = (e) => {
    ...
    const i = new RegExp(c.argTypesRegex);
    return Object.entries(r)
      .filter(([s]) => !!i.test(s))
      .reduce((s, [a, _u]) => (T(a, t) && (s[a] = _(a, { implicit: !0, id: n })), s), {});
  },
  M = (e) => {
    const {
      initialArgs: t,
    ...
    return n?.disable || !r
      ? {}
      : Object.entries(r)
          .filter(([_c, i]) => !!i.action)
          .reduce(
            (c, [i, s]) => (T(i, t) && (c[i] = _(typeof s.action === 'string' ? s.action : i)), c),
            {},
          );
  },
  Y = [M, B],
  ...
  P = (e) => {
    ...
    if (
      ...
      const r = l.__STORYBOOK_TEST_ON_MOCK_CALL__;
      r((n, c) => {
