...
var g = 'backgrounds',
  ...
  N = (r, e) => {
    const { globals: t, parameters: d, viewMode: a, id: o } = e,
  ...
  W = (r, e = [], t) => {
    ...
    const d = e.find((a) => a.name === t);
    if (d) return d.value;
    if (t) {
      const a = e.map((o) => o.name).join(', ');
      K.warn(Y`
  ...
  ee = {
    [g]: {
      ...
      disable: !1,
      ...(!FEATURES?.backgroundsStoryGlobals && { values: Object.values(C) }),
    },
  },
  Q = { [g]: { value: void 0, grid: !1 } },
  re = FEATURES?.backgroundsStoryGlobals ? Q : { [g]: null };
