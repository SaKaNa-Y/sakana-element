    ...
    : typeof window < 'u'
      ...
      : typeof global < 'u'
        ...
        : typeof self < 'u'
          ...
          : {};
function nr(n) {
  return n?.__esModule && Object.hasOwn(n, 'default') ? n.default : n;
}
var ge = { exports: {} };
((_n, a) => {
  ((_o, i) => {
      ...
      return (c, d, T) => {
        ...
        switch (O.type) {
          ...
          case 'JsdocTypeNumber':
            M = { type: 'JsdocTypeProperty', value: O.value.toString(10), meta: { quote: void 0 } };
            break;
      ...
      return g({
        ...
        parseInfix: (c, d) => {
          ...
          if (
            ...
            return (
              c.acceptLexerState(v), { type: 'JsdocTypeJsdocObjectField', left: w(d), right: x }
            );
          }
        },
      });
    ...
    const tn = g({
        ...
        accept: (e) => e === 'keyof',
        parsePrefix: (e) => (
          e.consume('keyof'), { type: 'JsdocTypeKeyof', element: w(e.parseType(f.KEY_OF_TYPE_OF)) }
        ),
      }),
      nn = g({
        name: 'importParslet',
    ...
    const gn = {
      ...
      JsdocTypeSpecialNamePath: (e) => {
        ...
        return {
          type: 'MODULE',
          value: { type: 'FILE_PATH', quoteStyle: j(e.meta.quote), path: e.value },
        };
      },
      JsdocTypeNamePath: (e, t) => {
        let r = !1,
...
var Be = /^['"]|['"]$/g,
  ...
  B = l((n) => {
    ...
    switch ((typeof o < 'u' && (u.raw = o), a)) {
      case 'enum': {
        const m = i ? p : p.map((h) => Ce(h.value));
      ...
      default: {
        if ((a == null ? void 0 : a.indexOf('|')) > 0)
          try {
            const E = a.split('|').map((N) => JSON.parse(N));
        ...
        return (
          (p = n.elements) != null && p.every((E) => E.name === 'literal')
            ? (h = {
                ...i,
                name: 'enum',
                value: (u = n.elements) == null ? void 0 : u.map((E) => Ce(E.value)),
              })
...
function et({ fence: n = '```' } = {}) {
  ...
  return l((i) => {
    let p = [[]],
      u = !1;
    for (const y of i)
      jn.test(y.tokens.description) && !u ? p.push([y]) : p[p.length - 1].push(y),
...
function nt({ startLine: n = 0, markers: a = _ } = {}) {
  ...
  return l((p) => {
    ...
    if (
      ...
      return i++, null;
    const m = u.trimRight().endsWith(a.end);
    if (
      (y.delimiter === '' &&
...
function ot(n = 'compact') {
  ...
  return (o) => {
    let i = 0,
      p = [];
    for (const [m, { tokens: h }] of o.source.entries()) {
      let E = '';
...
l(st, 'getJoiner');
var Un = l((n) => n?.startsWith('"') && n.endsWith('"'), 'isQuoted');
function it() {
...
l(ft, 'parse');
var $n = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  qn = l((n, a = $n) => {
...
var ar = l((n) => {
  ...
  tr = ((n) => ((n.AUTO = 'auto'), (n.CODE = 'code'), (n.DYNAMIC = 'dynamic'), n))(tr || {});
export { nr as a, we as b, ar as c, tr as g, zn as n, rr as o, or as y, Ne as z };
