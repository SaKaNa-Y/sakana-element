...
description: Sakana Element is a pixel-style Vue 3 component library with retro game aesthetics, TypeScript support, tree-shaking, dark mode, and bilingual documentation.
layout: home
hero:
  name: Sakana Element
